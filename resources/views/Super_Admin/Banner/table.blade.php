            ...
            @elseif($data->status==0)
                  ...
                  <button type="button" class="btn btn-danger" style="background-color:red">Deactive</button>
                    ...
                    @endif
                           ...
                           <td>
                              <a href="{{url('banner/Edit/')}}/{{$data->id}}"> <i class="fas fa-edit"></i> </a>
                              &nbsp;  &nbsp;
                              <a href="{{url('banner/Delete')}}/{{$data->id}}"> <i class="fas fa-trash"></i> </a> 
                           </td>
                        </tr>
                        @endforeach
                     </tbody>

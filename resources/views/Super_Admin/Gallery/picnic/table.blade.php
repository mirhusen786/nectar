         ...
         <div class="col-12">
            <div class="card">
               <div class="card-body">
                  ...
                  <a href="{{url('picnic/form')}}">
                     <button type="button" class="btn btn-success">Add Picnic Gallery </button>
                     </a>
            ...
            @elseif($data->status==0)
                  ...
                  <button type="button" class="btn btn-danger" style="background-color:red">Deactive</button>
                    ...
                    @endif
                           ...
                           <td>
                              <a href="{{url('picnic/Edit/')}}/{{$data->id}}"> <i class="fas fa-edit"></i> </a>
                              &nbsp;  &nbsp;
                              <a href="{{url('picnic/Delete')}}/{{$data->id}}"> <i class="fas fa-trash"></i> </a> 
                           </td>
                        </tr>
                        @endforeach
                     </tbody>

   ...
   <body>
      <div class="row">
         <div class="col-12">
          ...
          <tr>
            <td>{{$data['id']}}</td>
            <td>{{$data['icon_slug']}}</td>
            <td>{{$data['title']}}</td>
            <td>{{$data['info']}}</td>
            <td>{{$data['button_slug']}}</td>
            <td>{{$data['details']}}</td>
        
         
            <td>
               @if($data->status==1)
               <a href="{{url('service/status/0')}}/{{$data->id}}">
                  <button type="button" class="btn btn-success" style="background-color: green">Active</button>
                   </a>
            @elseif($data->status==0)
                  <a href="{{url('service/status/1')}}/{{$data->id}}">
                  <button type="button" class="btn btn-danger" style="background-color:red">Deactive</button>
                    ...
                    @endif
                           ...
                           <td>
                              <a href="{{url('service/Edit/')}}/{{$data->id}}"> <i class="fas fa-edit"></i> </a>
                              &nbsp;  &nbsp;
                              <a href="{{url('service/Delete')}}/{{$data->id}}"> <i class="fas fa-trash"></i> </a> 
                           </td>
                        </tr>
                        @endforeach
                     </tbody>

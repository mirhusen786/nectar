      ...
      <div class="row">
         <div class="col-12">
          ...
          <tr>
            ...
            <td><img src="{{asset('uploads/'.$data->auth_image)}}" width="100px" height="100px" alt=""></td>
            {{-- <td><img src="{{Storage::disk('uploads')->url($data->auth_image)}}" alt="" width="100px" height="100px"></td> --}}
            <td>{{$data['category']}}</td>
            <td>{{$data['title']}}</td>
            <td>{{$data['summary']}}</td>
            <td> {!!$data['image']!!}</td>
            ...
            @elseif($data->status==0)
                  ...
                  <button type="button" class="btn btn-danger" style="background-color:red">Deactive</button>
                    ...
                    @endif
                           ...
                           <td>
                              <a href="{{url('news/Edit/')}}/{{$data->id}}"> <i class="fas fa-edit"></i> </a>
                              &nbsp;  &nbsp;
                              <a href="{{url('news/Delete')}}/{{$data->id}}"> <i class="fas fa-trash"></i> </a> 
                           </td>
                        </tr>
                        @endforeach
                     </tbody>

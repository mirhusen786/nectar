...
@section('page_title','Comment Record')
@section('page_heading','Comment Record')
                  ...
                  <button type="button" class="btn btn-danger" style="background-color:red">Deactive</button>
                    ...
                    @endif
                           ...
                           <td>
                              ...
                              &nbsp;  &nbsp;
                              <a href="{{url('comment/Delete')}}/{{$data->id}}"> <i class="fas fa-trash"></i> </a> 
                           </td>
                        </tr>
                        @endforeach
                     </tbody>

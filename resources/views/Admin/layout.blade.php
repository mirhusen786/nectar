		...
		<div class="nav-header">
            <a href="index.html" class="brand-logo">
				...
				<div class="brand-title">
					<h2 class="">Hamar Hisab</h2>
					<span class="brand-sub-title">samirhusen18@gmail.com</span>
				</div>
            </a>
                    ...
                    <div class="collapse navbar-collapse justify-content-between">
                        ...
                        <ul class="navbar-nav header-right">
							...
							<li class="nav-item dropdown  header-profile">
								<a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown">
									<img src="{{asset('admin_assets/images/user.jpg')}}" width="56" alt="">
									<!-- <a class="dropdown-item ai-icon"> -->
								</a>
								<div class="dropdown-menu dropdown-menu-end">
            ...
            <div class="dlabnav-scroll">
				<ul class="metismenu" id="menu">
                    ...
                    <li><a class="has-arrow " href="javascript:void()" aria-expanded="false">
							...
							<span class="nav-text">Balance Details</span>
						</a>
                        <ul aria-expanded="false">
                    ...
                    <li><a class="has-arrow " href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="uc-select2.html">Staff Details</a></li>
                            <li><a href="uc-nestable.html">Staff Salary</a></li>
                            <li><a href="uc-noui-slider.html">Attendance</a></li>
                        </ul>
                    </li>
				...
				<div class="copyright">
					<p><strong>Hamar Hisab</strong> © 2021 All Rights Reserved</p>
					<p class="fs-12">Devlope by <span class="heart"></span>Mir husen Ray</p>
				</div>
			</div>
        </div>
        <!--**********************************
